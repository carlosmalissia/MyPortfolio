        ...
        <>
            ...
            <div className="grid items-center justify-center h-screen max-w-5xl gap-6 mx-auto md:grid-cols-2">
                <div className="max-w-[450px] z-10">
                    ...
                    <h1 className="text-2xl leading-tight text-center mt-[140px] md:mt-[-40px] md:text-center md:text-3xl  md:ml-20">Mis <span className="font-bold text-secondary"> servicios.</span></h1>
